...
export const TOOL_SPECS: ToolSpec[] = [
  ...
  { name: 'atel_agent_search', domain: 'identity', risk: 'read', phase: '1A', description: 'Search registry for agents/capabilities.' },
  ...
  { name: 'atel_contacts_list', domain: 'contacts', risk: 'read', phase: '1A', description: 'List platform-side contacts.' },
  { name: 'atel_inbox_list', domain: 'messaging', risk: 'read', phase: '1A', description: 'List relay/inbox messages.' },
  ...
  { name: 'atel_order_timeline', domain: 'order', risk: 'read', phase: '1A', description: 'Get timeline/domain events for an order.' },
  { name: 'atel_milestone_list', domain: 'milestone', risk: 'read', phase: '1A', description: 'List milestone structure and status.' },
  { name: 'atel_dispute_get', domain: 'dispute', risk: 'read', phase: '1A', description: 'Get dispute details.' },
  { name: 'atel_dispute_list', domain: 'dispute', risk: 'read', phase: '1A', description: 'List disputes.' },
  { name: 'atel_audit_order_get', domain: 'audit', risk: 'read', phase: '1A', description: 'Read MCP audit events for an order.' },
  { name: 'atel_audit_session_get', domain: 'audit', risk: 'read', phase: '1A', description: 'Read MCP audit events for the current or specified session.' },
  { name: 'atel_send_message', domain: 'messaging', risk: 'write', phase: '1B', description: 'Send a text P2P message via relay.' },
  { name: 'atel_ack', domain: 'messaging', risk: 'write', phase: '1B', description: 'Acknowledge inbox/relay messages.' },
  { name: 'atel_order_create', domain: 'order', risk: 'write', phase: '1C', description: 'Create an order using a narrow, safe schema.' },
  ...
  { name: 'atel_dispute_resolve', domain: 'dispute', risk: 'high-risk', phase: '2', description: 'Resolve a dispute.' }
];
